...
#define CAMBIO_GMT 2
#define CAMBIO_MQTT 3
int VALOR_UMBRAL_TEMP;
int VALOR_GMT;
int VALOR_MQTT;

//Funcion alarma con temperatura, led y buzzer
#define LED_VERDE 13
...
void loop() {
  switch (estado) {
    ...
    case CAMBIO_GMT:       //Pantalla 2: Para cambiar el valor de gmt
      //Print del display
      ...
      //Lo que tiene que suceder en este estado
      VALOR_GMT = lecturaBotonAbajo (VALOR_GMT, uno);
      VALOR_GMT = lecturaBotonArriba (VALOR_GMT, uno);
      Serial.print("Valor umbral GMT: ");
    ...
    case CAMBIO_MQTT:       //Pantalla 3: Para cambiar el tiempo de mqtt
      //Print del display
