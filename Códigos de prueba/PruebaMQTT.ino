...
const unsigned long interval_leo =  60000;//Intervalo de lectura de datos y guardado en la cola 
int i = 0;
...
void fun_entra (void)
{
  ...
  datos_struct[indice_entra].T1=20; /// leo los datos //aca va la funcion de cada sensor
